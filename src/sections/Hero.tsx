...
const Hero: React.FC = () => (
  <section id="home" className="min-h-screen pt-20 flex items-center relative overflow-hidden bg-grid">
    <div className="absolute top-1/4 -right-20 w-80 h-80 bg-indigo-100 rounded-full blur-3xl opacity-50"></div>
    <div className="absolute bottom-1/4 -left-20 w-80 h-80 bg-violet-100 rounded-full blur-3xl opacity-50"></div>
    ...
    <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10">
      ...
      >
        <div className="inline-block px-4 py-2 rounded-full bg-indigo-50 text-indigo-600 font-semibold text-xs mb-6 tracking-widest uppercase">
          Welcome to my universe
        </div>
        <h1 className="text-5xl md:text-7xl font-bold text-slate-900 mb-6 leading-[1.1]">
          I'm <span className="text-indigo-600">Rafi Ahmad</span> <br />
          Ghifari
        </h1>
        <p className="text-lg text-slate-600 mb-8 max-w-lg leading-relaxed">
          A dedicated <span className="font-semibold text-slate-900">Front End Developer</span> with 2 years of experience crafting interactive, high-performance web applications that users love.
        </p>
